...
- Mermaid support: first-class support for [Mermaid](https://mermaid.js.org/) - a JavaScript-based diagram and charting tool supported by GitHub - has been added to the theme. **This feature is opt-in.** See the documentation for more details on Configuration (mermaid-diagrams) and Code (mermaid-diagram-code-blocks).
...
See customization documentation for more. PR: [#1058].
...
In addition to customizing the search placeholder, we've also added the ability to provide custom content to the search index. PR: [#1068].
...
- Links wrap. PR: [#905]
- Callouts: a new component similar to alerts or banners. See documentation for Callouts. PR: [#466]
